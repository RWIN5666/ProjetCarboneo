...
// Initialisation de la base de données en cas de création
    public void initDataBase(){
        try {
          ...
          System.out.println("hey c'est super ca marche les amis bande d'enculés");
...
System.out.println(" On rentre 1");
        try {
            ...
            // bonne requete a taper
            // insert into table_route values(NULL, 'Brest', 'Guidel', 30,200,(select car_id from table_car where car_id=1),'2014-05-28');
